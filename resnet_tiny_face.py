...
output = output_1 + (output_2 + output_3 + output_5) / 3.0
...
with tf.Session() as test:
      test.run(init_op)
      train_writer = tf.train.SummaryWriter('./resnet_train_tiny_new', test.graph)
      ...
      for i in range(num_iter):
            ...
            i += 1
            if i % 100 == 0 and i > 0: saver.save(test, './face_model_tiny_new')
